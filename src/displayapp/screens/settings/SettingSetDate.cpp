...
std::unique_ptr<Screen> SettingSetDate::CreateScreen1() {
 ...
 void SettingSetDate::UpdateMonthLabel() {
  ...
  return std::make_unique<Screens::Label>(0, 2, app, title, icon, lblDay, lblMonth, lblYear, btnDayPlus, btnDayMinus, btnMonthPlus, btnMonthMinus, btnYearPlus, btnYearMinus, btnSetTime);
}
